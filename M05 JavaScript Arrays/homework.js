...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   numeroMayor = arrayOfNums[0];
   for (var i = 0; i < arrayOfNums.length;i++) {
      if (arrayOfNums[i] > numeroMayor) numeroMayor = arrayOfNums[i];
   }
   return numeroMayor;
}
...
function tablaDelSeis() {
   ...
   // La función devuelve un arreglo con los resultados de la tabla de multiplicar
