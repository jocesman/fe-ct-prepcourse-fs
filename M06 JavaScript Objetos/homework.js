...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   if (objetoUsuario && objetoUsuario.email !== undefined && objetoUsuario.email !== null) return true;
   else return false;
}
...
function verificarPassword(objetoUsuario, password) {
   // Verifica si la propiedad "password" del "objetoUsuario" coincide 
   //con el parámetro "password".
   // En ese caso retornar true. Caso contrario, false.
   // Tu código:
